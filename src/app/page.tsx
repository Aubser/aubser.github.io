...
import homepageImage from "../../public/HomePageResources/DroneOutside.jpg"
   ...
   return (
      <main className="min-h-screen">
         ...
         <section className="relative h-[700px] bg-black">
            ...
            <div className="relative max-w-7xl mx-auto px-6 pt-16 md:pt-34 h-full flex flex-col items-center justify-start text-center">
               <h1 className="text-5xl font-bold text-white mb-6 drop-shadow-lg" style={{ fontSize: "60px" }}>Revolutionize the Sky</h1>
